...
# add players
    def player(self):
        for numberOfPlayer in range(1,20+1):
            NameOfPlayerWhichIsWantJoin = input(f"{numberOfPlayer} chi ishtirokchi ismingizni kiriring: ")
            ...
            if NameOfPlayerWhichIsWantJoin in self.players:
                ...
                for NumberTwo in range(1,howMuchPeopleWilBe+1):
                    ...
                    pointOfThisTask = int(input(f"{NumberTwo} shartga nechi pointOfThisTask qo'yasiz: "))
                    ...
                    option = int(input(f"{NameOfPlayerWhichIsWantJoin} shartni bajardimi?\n1. xa\n2. yo'q\n(1/2): "))  
                    if option == 1:
                        self.players[NameOfPlayerWhichIsWantJoin]+=pointOfThisTask
                    else:
                        print(f"{NameOfPlayerWhichIsWantJoin} shartni bajarmadi va ball olmadi")
            ...
            if teams_name in self.teams:
                ...
                if optionOfTeam==1:
                    ...
                    for num3 in range(1,howMuchPeopleWilBe+1):
                        ...
                        pointOfThisTask = int(input(f"{num3} shartga nechi ball qo'yasiz: "))
                        self.scores[RuleOfGame] = pointOfThisTask
                        print(f"{RuleOfGame} ga {pointOfThisTask} ball qo'yiladi")
