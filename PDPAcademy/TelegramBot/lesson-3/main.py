...
async def inline_button(message: Message) -> None:
    design: list[list] = [
        [InlineKeyboardButton(text='Inline section 1', callback_data='Inline section 1'),
         InlineKeyboardButton(text='✅', callback_data='tick')],
        [InlineKeyboardButton(text='Inline section 2', callback_data='Inline section 2'),
         InlineKeyboardButton(text='✅', callback_data='tick')],
        [InlineKeyboardButton(text='Inline section 3', callback_data='Inline section 3'),
         InlineKeyboardButton(text='❌', callback_data='cross')],
        [InlineKeyboardButton(text='Inline section 4', callback_data='Inline section 4'),
         InlineKeyboardButton(text='❌', callback_data='cross')]
    ]
